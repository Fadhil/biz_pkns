  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved letter as @letter" do
        ...
        post :create, {:letter => { "subject" => "invalid value" }}, valid_session
        assigns(:letter).should be_a_new(Letter)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested letter" do
        ...
        Letter.any_instance.should_receive(:update_attributes).with({ "subject" => "MyString" })
        put :update, {:id => letter.to_param, :letter => { "subject" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the letter as @letter" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Letter.any_instance.stub(:save).and_return(false)
        put :update, {:id => letter.to_param, :letter => { "subject" => "invalid value" }}, valid_session
        assigns(:letter).should eq(letter)
      end
